package com.cognizant.copyprojectartifacts;
...
public class copyprojectartifacts {

	// Initialize the variable and logger

	private static org.apache.log4j.Logger logger = Logger
			.getLogger(copyprojectartifacts.class);
	...
	public copyprojectartifacts(final String version, final String classifier,
	...
	public boolean copy() {
		...
		try {
			...
			String target = "D:\\deployartifacts\\Dev";
	...
	public static void main(final String[] args) {
		...
		if (((version.endsWith("-SNAPSHOT")) && (environment
			...
			copyprojectartifacts ca = new copyprojectartifacts(version, classifier,
					environment);
