...
public class ClairDockerScannerBuilder extends Builder{
	...
	@DataBoundConstructor
	public ClairDockerScannerBuilder(String localImage, int high, int low, int medium, Boolean Severity,String localAnalyzerPath) {
	...
	public boolean perform(AbstractBuild build, Launcher launcher, BuildListener listener)
		...
		String 	BUILD_NUMBER = env.get("BUILD_NUMBER");
	...
	@Override
	 public Action getProjectAction(AbstractProject<?,?> project){
		 ...
		 return new ClairProjectAction(project,listener );
	    }
