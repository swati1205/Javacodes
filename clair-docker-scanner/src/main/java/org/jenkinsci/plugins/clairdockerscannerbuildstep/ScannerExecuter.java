...
public class ScannerExecuter {
	...
	public static int execute(AbstractBuild build, Launcher launcher, BuildListener listener, String artifactName,
			 String apiURL, String localImage,String localAnalyzerPath) throws IOException, InterruptedException {
		int exitCode = 0;
		...
		FilePath filename = Text_HTMLConverter.text_to_html(outFile, outfilFilePath1, out,build,listener);
