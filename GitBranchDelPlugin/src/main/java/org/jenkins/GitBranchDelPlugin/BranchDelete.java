...
public class BranchDelete extends Builder {
   String repoPath ;
   String branchName;
   String authFileLocation;
  String commitMsg = "Deleting a branch in github";
...
public void setAuthFileLocation(String authFileLocation) {
    ...
    public BranchDelete(String repoPath, String branchName,String authFileLocation) {
		this.repoPath=repoPath;
		this.branchName=branchName;
		this.authFileLocation= authFileLocation;
	...
	public boolean perform(AbstractBuild<?, ?> build,Launcher launcher, BuildListener listener) throws IOException, InterruptedException {
		...
		{
		git.deleteBranch(repoPath, branchName, authFileLocation, commitMsg, listener);
    	return true;
		}
		else
		{
